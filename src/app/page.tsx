    ...
    <main className="min-h-screen bg-[#0a0804] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 z-10">
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(196,154,60,0.10) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="relative z-10 max-w-2xl mx-auto hero-card">
          ...
          >
            ...
            <p className="label-tag animate-fade-up" style={{ animationDelay: '0.2s' }}>
              Undangan Acara
            </p>

            <div className="mb-8 animate-fade-up" style={{ animationDelay: '0.4s' }}>
              <p
                className="text-sm tracking-widest mb-2 italic"
                style={{ color: 'rgba(242,224,184,0.40)', fontFamily: 'var(--font-cormorant)' }}
              >
            ...
            <div className="animate-fade-up" style={{ animationDelay: '0.6s', fontFamily: 'var(--font-cormorant)' }}>
              <p className="text-sm tracking-[6px] uppercase mb-1" style={{ color: 'rgba(196,154,60,0.55)' }}>
                Acara Khitan
              </p>
      ...
      <section className="relative py-28 px-6 z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="section-title mb-16" style={{ fontFamily: 'var(--font-cormorant)' }}>
            Hitung Mundur
          </h2>
          <Countdown />
        </div>
      ...
      <section className="relative py-28 px-6 z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div
            className="border border-[rgba(196,154,60,0.18)] p-10 text-center relative overflow-hidden"
            style={{ background: 'rgba(196,154,60,0.03)' }}
          >
            <div
              className="absolute inset-0 pointer-events-none"
              style={{ background: 'radial-gradient(ellipse 80% 50% at 50% 100%, rgba(196,154,60,0.06), transparent)' }}
            />
            <span className="corner corner-tl" />
            <span className="corner corner-tr" />
            <span className="corner corner-bl" />
      ...
      <section className="relative py-28 px-6 z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <div className="section-badge mb-4">Momen Keluarga</div>
            <h2 className="section-title" style={{ fontFamily: 'var(--font-cormorant)' }}>
              Galeri Foto
            </h2>
          </div>
      ...
      <section className="relative py-28 px-6 text-center z-10">
        <div className="max-w-lg mx-auto">
          ...
          <p
            className="text-xl md:text-2xl italic font-light mb-5"
            style={{ fontFamily: 'var(--font-cormorant)', color: '#e8d5a3', lineHeight: 1.8 }}
          >
            (Nabi) Ibrahim berkhitan setelah berusia delapan puluh tahun dan beliau khitan dengan menggunakan sejenis pisau
          </p>
          <p className="text-[10px] tracking-[4px] uppercase" style={{ color: 'rgba(196,154,60,0.45)' }}>
